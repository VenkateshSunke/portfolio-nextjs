            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div className="space-y-6">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight">
                        Hi, I'm{" "}
                        <span className="bg-gradient-to-r from-gray-200 to-[#888888] bg-clip-text text-transparent">
                            Your Name
                        </span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
                        <a
                            ...
                            className="px-8 py-3 bg-white text-gray-900 rounded-lg font-semibold hover:bg-gray-200 transition-colors duration-200 shadow-lg hover:shadow-xl"
                        >
                            View My Work
                        </a>
                        <a
