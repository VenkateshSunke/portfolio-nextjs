            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div className="space-y-6">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-gray-900 leading-tight">
                        Hi, I'm{" "}
                        <span className="text-gray-800 underline decoration-[#888888] decoration-4 underline-offset-4">
                            Your Name
                        </span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
                        <a
                            ...
                            className="px-8 py-3 bg-gray-900 text-white rounded-lg font-semibold hover:bg-gray-800 transition-colors duration-200 shadow-lg"
                        >
                            View My Work
                        </a>
                        <a
                            href="#contact"
                            data-probat-conversion="true"
                            className="px-8 py-3 bg-transparent text-gray-900 border-2 border-gray-900 rounded-lg font-semibold hover:bg-white transition-colors duration-200"
                        >
                            Get In Touch
                        </a>
                    </div>
