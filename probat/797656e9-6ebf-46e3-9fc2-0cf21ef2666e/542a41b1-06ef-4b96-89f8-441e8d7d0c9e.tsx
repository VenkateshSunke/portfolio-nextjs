            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            <div className="w-64 h-64 mx-auto bg-[#333333] border-4 border-[#888888] rounded-full flex items-center justify-center text-[#F1F1F1] text-6xl font-bold">
                                YN
                            </div>
                        </div>
                        <div className="space-y-4 text-lg text-[#cccccc]">
                            <p>
