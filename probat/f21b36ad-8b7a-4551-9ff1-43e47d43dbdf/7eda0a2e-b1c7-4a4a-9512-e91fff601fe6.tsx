                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
                        <a
                            ...
                            className="px-8 py-3 bg-[#888888] text-white rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-colors duration-200 shadow-lg hover:shadow-xl"
                        >
                            View My Work
                        </a>
                        <a
                            href="#contact"
                            data-probat-conversion="true"
                            className="px-8 py-3 bg-transparent text-white border-2 border-gray-600 rounded-lg font-semibold hover:bg-gray-800 transition-colors duration-200"
                        >
                            Get In Touch
                        </a>
                    </div>
