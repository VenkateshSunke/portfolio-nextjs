            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div className="space-y-6">
                    <div className="inline-block">
                        <span className="px-4 py-2 bg-white text-gray-900 border border-gray-200 rounded-full text-sm font-medium">
                            Welcome to my Portfolio
                        </span>
                    </div>
                    <h1 className="text-5xl md:text-7xl font-bold text-gray-900 leading-tight">
                        Hi, I'm{" "}
                        <span className="text-black underline decoration-[#888888] decoration-4 underline-offset-4">
                            Your Name
                        </span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
                        ...
                        <a
                            href="#contact"
                            data-probat-conversion="true"
                            className="px-8 py-3 bg-transparent text-black border-2 border-black rounded-lg font-semibold hover:bg-gray-200 transition-colors duration-200"
                        >
                            Get In Touch
                        </a>
                    </div>
